...
var tank  = prompt("What is the size of your gas tank?");//Prompting user for the size of gas tank.
    if (tank == ("")){var tank = prompt ("What is the size of your gas tank?");}//Repeating the prompt in case it was left blank the first time.
...
var mile  = prompt("How many miles do you average per tank of fuel?");//Prompting user for average number of miles per tank of fuel.
    if (mile == ("")){var mile = prompt ("How many miles do you average per tank of fuel?");}//Repeating the prompt in case it was left blank the first time.
...
var result = mpg(mile,tank);//Invoking the function with given arguments.
